...
export const resumeFixtures = [
  {
    ...
    facts: [
      ...
      { kind: 'skill', label: 'SQL', detail: '', dateText: null, excerpt: 'Skills: Python, SQL' },
      {
        kind: 'experience',
        label: 'Survey project',
        detail: 'Cleaned survey data with Python and wrote SQL queries.',
        dateText: null,
        excerpt: 'Survey project: Cleaned survey data with Python and wrote SQL queries.',
      },
      {
        kind: 'education',
        ...
        excerpt: 'Education: BSc Computer Science, Example University, expected 2027.',
      },
    ],
  },
  {
    ...
    facts: [
      ...
      },
      {
        ...
        dateText: null,
        excerpt: 'Class website: Built a keyboard-accessible website with JavaScript.',
      },
      {
        kind: 'education',
        label: 'BSc Computing',
    ...
    facts: [
      {
        ...
        detail: 'Organized weekly volunteer meetings and documented action items.',
        dateText: null,
        excerpt:
          'Community project: Organized weekly volunteer meetings and documented action items.',
      },
...
export const demoPaths: ReviewedPath[] = [
  {
    ...
    requirements: [
      { id: 'sample-python', skill: 'Python', excerpt: 'Use Python to clean and inspect data.' },
    ],
  },
  {
    id: 'software',
    ...
    requirements: [
      { id: 'sample-js', skill: 'JavaScript', excerpt: 'Build interfaces with JavaScript.' },
    ],
  },
];
